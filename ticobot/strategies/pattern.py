...
class Pattern:
    ...
    def dragonflyDoji(self):
        ...
        return 'call' if c5 and c4 and c3 and doji and last else 'ntr'
    ...
    def hangedMan(self):
        ...
        return 'put' if c5 and c4 and c3 and hanged and last else 'ntr'
    ...
    def bearishEngulfing(self):
        ...
        return 'put' if c6 and c5 and c4 and engulfing and bearish and last else 'ntr'
    ...
    def bullishEngulfing(self):
        ...
        return 'call' if c6 and c5 and c4 and engulfing and bullish and last else 'ntr'
    ...
    def cozBullish(self):
        ...
        return 'call' if red and green and last else 'ntr'
    ...
    def morningStar(self):
        ...
        return 'call' if c6 and c5 and c4 and red and gap and green else 'ntr'

    def morningStarDoji(self):
        '''
        ...
        green = c['open'][-1] > c['low'][-2] and c['open'][-1] < c['high'][-1] and c['low'][-1] < c['open'][-1] and c['high'][-1] < c['close'][-1]
        return 'call' if c6 and c5 and c4 and red and doji and green else 'ntr'
    ...
    def eveningStar(self):
        ...
        return 'call' if c6 and c5 and c4 and red and star and green else 'ntr'